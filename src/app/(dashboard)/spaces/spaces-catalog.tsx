...
import { Accessibility, Users, MapPin, X, Filter } from "lucide-react";
...
export function SpacesCatalog({ spaces, equipmentOptions }: Readonly<SpacesCatalogProps>) {
  ...
  }, [minCapacity, accessibilityOnly, selectedEquipment, router]);
  ...
  }, [spaces, minCapacity, accessibilityOnly, selectedEquipment]);
  ...
  const hasFilters = minCapacity > 0 || accessibilityOnly || selectedEquipment.length > 0;
